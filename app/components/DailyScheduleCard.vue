...
<template>
  <div class="mb-10">
    ...
    <div class="text-center mb-8">
      <div
        class="inline-block px-6 py-3 rounded-2xl text-2xl font-bold shadow-lg border-4 border-white transform hover:scale-105 transition-transform"
        :style="{
      ...
      <p
        ...
        class="mt-3 text-base text-gray-700 font-medium"
        :style="{
    ...
    <!-- Shifts -->
    <div class="bg-white/50 backdrop-blur-sm rounded-3xl p-6 shadow-xl">
      <ShiftCard
