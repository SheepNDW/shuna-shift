  ...
  <div class="mx-auto mb-12 max-w-3xl space-y-6">
    <div class="flex flex-col items-center">
      <div class="relative mb-6 h-40 w-40 md:h-48 md:w-48">
        <div
          class="h-full w-full overflow-hidden rounded-full bg-linear-to-br from-pink-200 to-purple-200 dark:from-pink-900 dark:to-purple-900 ring-4 ring-pink-100 transition-all hover:ring-pink-300 dark:ring-pink-900/50 dark:hover:ring-pink-700"
        >
          <NuxtImg
        ...
        <div
          class="absolute -bottom-2 -right-2 flex h-12 w-12 items-center justify-center rounded-full bg-pink-500 shadow-lg border-4 border-white dark:border-gray-800"
        >
    ...
    <UCard v-if="hasPhotos" data-testid="agent-photo-section">
      <template #header>
        <div class="flex items-center gap-2">
          ...
          <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">照片</h2>
        </div>
      </template>
