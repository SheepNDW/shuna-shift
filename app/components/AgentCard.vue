  ...
  >
    <NuxtLink :to="`/agents/${agentInfo.id}`">
      <div class="relative w-28 h-28 mb-4">
        <div
          class="w-full h-full overflow-hidden rounded-full bg-linear-to-br from-pink-200 to-purple-200 ring-4 ring-pink-100 group-hover:ring-pink-300 transition-all"
        >
          <NuxtImg
